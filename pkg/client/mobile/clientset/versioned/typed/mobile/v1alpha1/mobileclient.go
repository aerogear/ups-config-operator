...
type MobileClientInterface interface {
	Create(*v1alpha1.MobileClient) (*v1alpha1.MobileClient, error)
	Update(*v1alpha1.MobileClient) (*v1alpha1.MobileClient, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.MobileClient, error)
	List(opts v1.ListOptions) (*v1alpha1.MobileClientList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.MobileClient, err error)
...
func newMobileClients(c *MobileV1alpha1Client, namespace string) *mobileClients {
...
func (c *mobileClients) List(opts v1.ListOptions) (result *v1alpha1.MobileClientList, err error) {
	result = &v1alpha1.MobileClientList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mobileclients").
